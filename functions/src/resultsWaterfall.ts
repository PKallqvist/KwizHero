/**
 * Mirror of src/domain/resultsWaterfall.ts. The functions/ package builds independently
 * (see functions/tsconfig.json, rootDir: "src") and does not import from src/, so this
 * is a deliberate duplicate — keep it in sync with the canonical, Vitest-covered copy.
 */
