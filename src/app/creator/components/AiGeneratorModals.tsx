...
export function useAiGenerator(params: {
  ...
  function openAiGenerator(): void {
    ...
    if (!isAdmin) {
      refreshAiTokenBalance().then(() => setAiPanelOpen(true)).catch(() => setAiPanelOpen(true));
      return;
    }
    setAiPanelOpen(true);
      ...
      >
        <Stack gap="sm">
          <Group justify="space-between" align="center">
            ...
            {isAdmin ? (
              <Badge color="teal" variant="light">Admin</Badge>
            ) : (
            ...
            {aiPreviewQuestion ? (
              <>
                <Button
                  ...
                  disabled={aiLoading || (!isAdmin && (aiTokenBalance ?? 0) < 1)}
                >
              ...
              <Button
                ...
                onClick={() => void generateQuestionWithAi()}
                loading={aiLoading}
                disabled={!isAdmin && (aiTokenBalance ?? 0) < 1}
              >
